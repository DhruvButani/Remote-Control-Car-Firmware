...
// TEMP: disabled alongside task_console_init() in main.c to free SCB5
// for LCD SPI. With this false, task_print(...) macros become no-ops so
// existing call sites compile and run without needing the console task.
