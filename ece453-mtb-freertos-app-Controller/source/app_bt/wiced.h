...
/* TEMP: stubbed out -- raw printf has no retarget_io backend, and once SCB5
 * is owned by the LCD SPI any printf bytes would corrupt the OLED bus. */
#define WPRINT_BT_APP_INFO(info)   do {} while(0)
